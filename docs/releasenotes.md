...
- Add column "Incremento sugerido con el mismo coste para el donante (nueva ley de mecenazgo)" to Model182 report to estimate the increase in donation that the donor can make in 2024 compared to 2023 without incurring an extra cost
- Fix unnecessary postal code validations
- Add information for donations ofImporte contribución 2024 donors without a registered postal code on the "statistics table" of Model182 report
