...
return array(
  ...
  'atmod182_2024TotalField' => array(
    'name' => 'atmod182_2024TotalField',
    'quick_form_type' => 'Element',
    'type' => 'Number',
    'html_type' => 'Select',
    'add' => '5.3',
    'title' => E::ts('2024 Total Donation Amount'),
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => NULL,
    'help_text' => NULL,
    'pseudoconstant' => array(
      'callback' => 'CRM_Atmod182_Form_ATMod182Admin::getNumberFields',
    ),
  ),
  'atmod182_moreDonationSameCostField' => array(
    'name' => 'atmod182_moreDonationSameCostField',
    'quick_form_type' => 'Element',
    'type' => 'Number',
    'html_type' => 'Select',
    'add' => '5.3',
    'title' => E::ts('More Donation At Same Cost'),
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => NULL,
    'help_text' => NULL,
  ...
  'atmod182_beforeMinDonationDevolutionField' => array(
    'name' => 'atmod182_beforeMinDonationDevolutionField',
    'quick_form_type' => 'Element',
    'type' => 'Number',
    'html_type' => 'Select',
    'add' => '5.3',
    'title' => E::ts('Before Minimum Donation Devolution'),
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => NULL,
    'help_text' => NULL,
  ...
  'atmod182_currentMinDonationDevolutionField' => array(
    'name' => 'atmod182_currentMinDonationDevolutionField',
    'quick_form_type' => 'Element',
    'type' => 'Number',
    'html_type' => 'Select',
    'add' => '5.3',
    'title' => E::ts('Current Minimum Donation Devolution'),
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => NULL,
    'help_text' => NULL,
  ...
  'atmod182_realMaxDonationCostField' => array(
    'name' => 'atmod182_realMaxDonationCostField',
    'quick_form_type' => 'Element',
    'type' => 'Number',
    'html_type' => 'Select',
    'add' => '5.3',
    'title' => E::ts('Real Maximum Donation Cost'),
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => NULL,
    'help_text' => NULL,
